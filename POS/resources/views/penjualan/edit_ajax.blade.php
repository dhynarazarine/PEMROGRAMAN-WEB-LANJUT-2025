@empty($penjualan)
<!-- sama seperti sebelumnya: tampilkan pesan error -->
@else
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="form-group">
                    ...
                    <input value="{{ $penjualan->tanggal_penjualan }}" type="date" name="tanggal_penjualan" id="tanggal_penjualan" class="form-control" required>
